...
namespace BigBazarDataAccessLayer
    {
    public class BigBazarDBContext : DbContext
        {
        public BigBazarDBContext()
            {
            }

        public BigBazarDBContext(DbContextOptions<BigBazarDBContext> options)
            : base(options)
            {
            }
        ...
        public virtual DbSet<Receipt> Receipts
            {
            get; set;
            }
